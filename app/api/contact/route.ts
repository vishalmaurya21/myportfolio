        ...
        <div style="font-family:monospace;max-width:600px;margin:0 auto;padding:32px;background:#0d0d0d;color:#f4f4f5;border-radius:12px;">
          ...
          <table style="width:100%;border-collapse:collapse;margin-bottom:24px;font-size:12px;">
            <tr>
              ...
              <td style="padding:8px 12px;background:#1a1a1a;color:#f4f4f5;">${email}</td>
            </tr>
            <tr>
              <td style="padding:8px 12px;background:#111;color:#888;">Reply-to</td>
              <td style="padding:8px 12px;background:#111;color:#a8ff78;">${email}</td>
            </tr>
          </table>
          <div style="background:#161616;border-left:3px solid #e31616;padding:20px;border-radius:0 8px 8px 0;font-size:14px;line-height:1.7;color:#d4d4d4;white-space:pre-wrap;">${message}</div>
      ...
      html: `
        <div style="font-family:monospace;max-width:600px;margin:0 auto;padding:32px;background:#0d0d0d;color:#f4f4f5;border-radius:12px;">
          ...
          <h2 style="font-size:22px;font-weight:900;margin:0 0 12px;letter-spacing:-0.03em;">
            Hey ${name.split(' ')[0]}, message received!
          </h2>
          ...
          <div style="background:#161616;border-left:3px solid #333;padding:16px 20px;border-radius:0 8px 8px 0;font-size:13px;color:#666;white-space:pre-wrap;">${message}</div>
          <p style="margin:24px 0 0;font-size:11px;color:#444;">
