...
const ScrollStack = ({
  ...
  const updateCardTransforms = useCallback(() => {
    ...
    cardsRef.current.forEach((card, i) => {
      ...
      const initialTop = cardPositionsRef.current[i] || 0;
      ...
      if (blurAmount) {
        ...
        for (let j = 0; j < cardsRef.current.length; j++) {
          const jInitialTop = cardPositionsRef.current[j] || 0;
      ...
      if (isPinned) {
        translateY = scrollTop - initialTop + stackPositionPx + itemStackDistance * i;
      } else if (scrollTop > pinEnd) {
        translateY = pinEnd - initialTop + stackPositionPx + itemStackDistance * i;
      }
  ...
  useLayoutEffect(() => {
    ...
    // Small timeout to ensure cards are in their natural positions before caching
